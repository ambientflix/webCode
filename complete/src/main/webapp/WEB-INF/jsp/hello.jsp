                        ...
                        <div class = 'row mb-3'>
                            <div class = 'col p-4'>
                                <div class="card card-common" style = "background-color:black">
                                    ...
                                    <div class = 'card-footer text-secondary' style = "background-color:#3d424a">
                                        <div class = 'mt-4'>
                                            <div class='panel-group'>
                                                <div class='panel panel-default'>
                                                    <!--<a data-toggle='collapse' data-parent='#accordion' href='#collapse'>-->
                                                    <a data-toggle='collapse' data-parent='#accordion' href = '#collapse1'>
                                                        <div class='panel-heading' style = 'background-color:#989a9c'>
                                                            <h4 class='panel-title text-center' style = 'color:white;'>Learn more!</h4>
                                                        </div>
                                                    </a>
